...
--{{
--|  Author: Aegonian
--|  Source: https://github.com/Aegonian/ElithianAllianceStarboundMod/blob/master/objects/scripts/thea-backgrounddoor.lua
--|  Repo: https://github.com/Aegonian/ElithianAllianceStarboundMod/
--|  License: None?
--}}
function init()
