...
zFlipSlash = WeaponAbility:new()

function zFlipSlash:init()
  self.cooldownTimer = self.cooldownTime
end

function zFlipSlash:update(dt, fireMode, shiftHeld)
